...
case _code_standalones_if: \
	if(data[data[definition_standalones_if_boolean + pos]] & _code_primitive_bool_mask == _code_primitive_bool){ \
		translation_if_bool_strict__; \
	} \
	else if(data[data[definition_standalones_if_boolean + pos]] & _code_t_bool_mask == _code_t_bool){ \
		pos = data[definition_standalones_if_boolean + pos]; \
		if(data[data[definition_t_bool_operation + pos]] == _code_t_bool_operation_greater_or_equal_than){ \
			translation_if_bool_greater_or_equal_than; \
		} \
		else if(data[data[definition_t_bool_operation + pos]] == _code_t_bool_operation_greater_than){ \
			translation_if_bool_greater_than; \
		} \
		else if(data[data[definition_t_bool_operation + pos]] == _code_t_bool_operation_less_or_equal_than){ \
			translation_if_bool_less_or_equal_than; \
		} \
		else if(data[data[definition_t_bool_operation + pos]] == _code_t_bool_operation_less_than){ \
			translation_if_bool_less_than; \
		} \
		else if(data[data[definition_t_bool_operation + pos]] == _code_t_bool_operation_strict_and){ \
			translation_if_bool_strict_and; \
		} \
		else if(data[data[definition_t_bool_operation + pos]] == _code_t_bool_operation_strict_not){ \
			translation_if_bool_strict_not; \
		} \
		else if(data[data[definition_t_bool_operation + pos]] == _code_t_bool_operation_strict_or){ \
			translation_if_bool_strict_or; \
		} \
		else if(data[data[definition_t_bool_operation + pos]] == _code_t_bool_operation_strict_xor){ \
